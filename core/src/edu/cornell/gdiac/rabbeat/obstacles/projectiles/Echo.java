...
public class Echo extends WheelGameObject implements ISynced, IGenreObject {
    ...
    public Echo(float x, float y, float radius, Animation<TextureRegion> beeAttackAnimation) {
        super(x, y, radius);
        hiveY = y;
